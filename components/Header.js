...
export default function Header() {
    ...
    return (
        ...
        <header className=' flex justify-between content-center bg-zinc-900 bg-opacity-30'>
            ...
            <button className=' flex flex-row px-2 mx-2 rounded-md bg-emerald-800 text-white hover:bg-indigo-500 hover:animate-bounce' onClick={logout}>Logout<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 pl-2">
