...
<div className="container flex w-1/4 flex-col items-center p-2 mx-auto my-3 rounded-md bg-black bg-opacity-30">
  <form onSubmit={handleSubmit} className="items-center">
    <fieldset autoComplete="off" className="items-center">
      ...
      <button className="text-white bg-emerald-600 hover:bg-blue-300 font-medium  hover:animate-pulse rounded-md text-sm px-5 py-2.5 mt-2 w-full flex flex-row justify-center align items-center">
